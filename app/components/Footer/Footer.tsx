...
const BaseFooter = () => {
  return (
    <div className="flex w-full grow-0 flex-col items-center text-lg md:fixed md:bottom-12 md:left-0 md:right-0">
      <Card
        header={
      ...
      >
        <div className="flex space-x-3">
          {/* LinkedIn icon */}
          <AppLink to="https://www.linkedin.com/in/devin-blair/" variant="icon">
